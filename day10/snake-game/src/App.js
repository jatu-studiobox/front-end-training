...
class App extends Component {
  ...
  render() {
    ...
    this.numCells = Math.floor(this.props.sizes / 15);
    const cellSize = this.props.sizes / this.numCells;
    ...
    return (
      <div
        ...
        style={{
          width: this.props.sizes + "px",
          height: this.props.sizes + "px"
        }}
        ref={el => (this.el = el)}
        tabIndex={-1}
      >
